@EndUserText.label: 'Custom Entity for Agency data from ES5'
@ObjectModel.query.implementedBy: 'ABAP:ZCL_CE_BTC_AGENCY'
define root custom entity ZCE_BTC_AGENCY
{
